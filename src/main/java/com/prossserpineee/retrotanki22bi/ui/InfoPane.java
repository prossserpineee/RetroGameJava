...
/*
 * В правой части игрового поля отображается информационный интерфейс,
 * показывающий количество вражеских танков и уровень пуль
 */
public class InfoPane extends Pane {
    ...
    public InfoPane() {
        ...
        tilePane.setPrefSize(100, 390);
        for (int i = 0; i < GameConfig.ENEMY_AMOUNT + (5 * geti("level")); i++) {
        ...
        getip("spawnedEnemy").addListener((ob, ov, nv) -> {
            for (int i = enemyPreNodes.size() - 1; i >= GameConfig.ENEMY_AMOUNT + (5 * geti("level")) - nv.intValue(); i--) {
